...
if [ "${TESTING_PROFILE}" = "toil-integration-tests" ]; then
    ...
    pip3 install -r https://raw.githubusercontent.com/dockstore/dockstore/develop/dockstore-webservice/src/main/resources/requirements/1.13.0/requirements3.txt
fi
